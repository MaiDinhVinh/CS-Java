...
public class TeacherIndexUIController implements Initializable {
    ...
    void btnUpdateTeacherClick(ActionEvent event) throws IOException {
        ...
        if(selectedTeacher == null){
            ...
            noSelectedTeacher.setTitle(Translation.getTranslator().getString("index.alert.teacher.update.error.title"));
            noSelectedTeacher.setHeaderText(Translation.getTranslator().getString("index.alert.teacher.update.error.header"));
    ...
    void btnTeacherDeleteClick(ActionEvent event) {
        ...
        if(isNull){
            ...
            deleteRowErr.setTitle(Translation.getTranslator().getString("alert.teacher.delete.error.title"));
            deleteRowErr.setHeaderText(Translation.getTranslator().getString("alert.teacher.delete.error.header"));
            deleteRowErr.show();
        }else{
            Alert deleteRowConfirmation = new Alert(Alert.AlertType.CONFIRMATION);
            deleteRowConfirmation.setTitle(Translation.getTranslator().getString("alert.teacher.delete.confirm.title"));
            deleteRowConfirmation.setHeaderText(Translation.getTranslator().getString("alert.teacher.delete.confirm.header"));
