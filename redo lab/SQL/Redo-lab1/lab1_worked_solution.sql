...
VALUES(1, 'Exotic Liquids', 'Charlotte Cooper'
      , 'Purchasing Manager', '49 Gilbert St. ', 'London'
      , NULL, 'EC1 4SD', 'UK', '(171) 555-2222');


INSERT INTO Suppliers
(SupplierID, CompanyName, ContactName, ContactTitle, Address, City
, Region, PostalCode, Country, Phone)
VALUES(2,'New Orleans Cajun Delights', 'Shelly Burke'
...
VALUES(3, 'Grandma Kelly\'s Homestead', 'Regina Murphy',
       'Sale Representative', '707 Oxford Rd.',
       'Ann Arbor', 'MI', '48104', 'USA', '(313) 555-5735');

INSERT INTO Suppliers
(SupplierID, CompanyName, ContactName, ContactTitle, Address, City,
 Region, PostalCode, Country, Phone)
VALUES(4, 'Tokyo Traders', 'Yoshi Nagase', 'Marketing Manager',
       '9-8 Sekimai Muashino-shi', 'Tokyo', NULL,
...
VALUES(5, 'Cooperativa de Quesos \'Las Cabras\'',
       ...
       'Calle del Rosal 4', 'Ovideo', 'Asturias', '33007',
       'Spain', '(98) 598 76 54');
...
CREATE TABLE Products(
    ...
    UnitsInStock SMALLINT UNSIGNED,
    UnitsOnOrder SMALLINT UNSIGNED,
    ReorderLevel SMALLINT UNSIGNED,
...
(ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice,
 UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued)
VALUES(4, 'Chef Anton\'s Cajun Seasoning', 2, 2,
...
-- ex: update products 'Chai', 'Chang' to have supplierId = 4 (WILL UPDATE TO 3 BECAUSE 4 ISN'T EXIST IN SUPPLIER TABLE)
UPDATE Products
SET SupplierID = 3
